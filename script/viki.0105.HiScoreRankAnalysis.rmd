...
# Title: Segmentation of User Base and Ranking of Videos
___
...
```
* we developed a ranking scheme for videos Ranks = f(frequency of visits, score). We gave high weights to videos with mv_ratio   >=50 

Logic: This is to overcome the dilemma where a highly clicked video with very low score may rank equal to a moderately                  viewed video with highScore. 
Formulae for Ranking (based on new scoring system):

> (score1views*1 +score2views*2 + score3views*3 + score4views*4)* (score3views+score4views)*totalviews)
